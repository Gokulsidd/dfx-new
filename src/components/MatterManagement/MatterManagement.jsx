          ...
          <Tooltip>
            ...
            >
              <div className="relative">
                <Briefcase className="w-12 h-12 text-gray-300 group-hover:text-blue-300 transition-colors" />
                {/* <div className="absolute inset-0 rounded-full bg-blue-500/10 scale-0 group-hover:scale-150 opacity-0 group-hover:opacity-100 transition-all duration-100" /> */}
              </div>
              <div className="flex flex-col gap-1" >
              <span className="text-lg font-medium text-gray-600  transition-colors duration-200">
                {configs?.labels.matter_folder.label}
              </span>
              <span className="text-sm text-gray-400  transition-colors duration-200">
                {configs?.labels.matter_folder.sub_heading}
              </span>
              </div>
            </Button>
          </Tooltip>
